...
(function () {
  ...
  let main = {
    setStyle(val) {
      GM_addStyle(`
        *:not(pre) {
            -webkit-text-stroke: ${val}px !important;
            text-stroke: ${val}px !important;
        }
      `);
    },
    ...
    initSetting() {
      ...
      if (GM_getValue('current_val')) {
        main.setStyle(GM_getValue('current_val'));
      }
